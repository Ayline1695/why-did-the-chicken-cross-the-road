...
function Obstacle(canvas, ctx, speed, row, direction, width, x, y) {
	...
	this.obstacleImage1.src = "./assets/img/obstacle1.png";
	this.obstacleImage2.src = "./assets/img/obstacle2.png";
	this.obstacleImage3.src = "./assets/img/obstacle3.png";
	this.obstacleImage4.src = "./assets/img/obstacle4.png";
}
